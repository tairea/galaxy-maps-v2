...
export class EdgeInfoPanel {
  ...
  constructor(page: Page) {
    ...
    this.panel = page.locator('[data-testid="edge-info-panel"]').or(page.locator(".edge-info-panel"));

    // Buttons
    this.deleteEdgeButton = page
      .locator('[data-testid="delete-edge-button"]')
  ...
  async waitForClose(timeout = 5000) {
    await this.panel.waitFor({ state: "detached", timeout });
  }
